...
import { faBullhorn, faUser, faCalendarAlt, faSignOutAlt, faBusinessTime, faComments, faSitemap, faHandHoldingUsd, faTicketAlt, faPaperclip, faUserFriends } from '@fortawesome/free-solid-svg-icons';
import './AllService.css'; // Adjust the path if necessary
